...
//    private SignInButton mSignInButton;
    ...
    private TextView mStatus;private TextView mStatusTextView;
...
//        mRevokeButton.setEnabled(true);
        ...
        try {
            ...
            Log.i( TAG, "Signed In to My App as " + emailAddress );
        }
        catch(Exception ex){
...
//                    String testEmailAddress = Plus.AccountApi.getAccountName(mGoogleApiClient);
//                    Log.i( TAG, "Signed In to My App as " + testEmailAddress );
